...
import static com.service.parking.parksepeti.Services.NetworkServices.userProfile;

public class ParkBilgiDetayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNextBtn.setOnClickListener(v -> {
            if (checkData()) {
                Intent toAdditionalDetailPage = new Intent(ParkBilgiDetayActivity.this, FiyatActivity.class);
        ...
        segmentedButtonGroup.setOnClickedButtonListener(position -> {
            if(position == 0){
                ...
                final AlertDialog.Builder builder = new AlertDialog.Builder(ParkBilgiDetayActivity.this);
                View view = LayoutInflater.from(ParkBilgiDetayActivity.this).inflate(R.layout.custom_other_dialog,null);
